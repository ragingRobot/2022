...
export default class extends AbstractGame {
    ...
    addBackground() {
        ...
        this.objects.push(this.add.sprite(1700, 550, 'gamesprites', 'sprite-1.png'));
        this.objects.push(this.add.sprite(2150, 570, 'gamesprites', 'sprite-2.png'));
        this.objects.push(this.add.sprite(300, 910, 'gamesprites', 'sprite-3.png'));
        this.objects.push(this.add.sprite(650, 900, 'gamesprites', 'sprite-4.png'));
        this.objects.push(this.add.sprite(1130, 875, 'gamesprites', 'sprite-3.png'));
