    ...
    return (
        <>
            ...
            <h2>Skills</h2>
                ...
                <h3>Contract Front-End Developer, Look-Listen (Sept 2014-Nov 2014)</h3>
                <p>Worked on Benevis.com.</p>
                <h3>Senior Developer, BFG Interactive (June 2012-Sept 2014)</h3>
                ...
                <h3>Front-End Developer, Savannah College of Art and Design (June 2009-June 2012)</h3>
                ...
                <h3>Lead Programmer (2009), Gulf Stream/Savannah College of Art and Design</h3>
                <p>Lead Programmer on a project for Gulf Stream in affiliation with the Savannah College of Art and Design.</p>
